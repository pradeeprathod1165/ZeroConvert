...
const formatOptions = ['JPG', 'PNG', 'WEBP', 'MP3', 'MP4'];
            ...
            <div className="flex items-center gap-4 md:gap-6 shrink-0">
              ...
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="bg-zinc-950 border border-zinc-700 text-sm text-zinc-200 rounded-md px-2 py-1.5 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 disabled:opacity-50"
                >
